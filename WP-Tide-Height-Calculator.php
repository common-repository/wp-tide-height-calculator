...
Plugin URI: https://wordpress.org/plugins/wp-tide-height-calculator
Description: WP-Tide-Height-Calculator is a plugin that gives an indication of the height of the tide at certain times in the tidal phase. Add [tide] in any page/post to show the calculator. Use shortcode block in the visual editor and then add [tide] to show the calculator.
Version: 1.8
			...
			#error_message{
				color: red;
					...
					<tbody>
						...
						<tr>
							<td colspan="4"><strong>&copy; The Tidal Press - <a href="http://www.thetidalpress.com" target="_blank">www.thetidalpress.com</a> - 07975 830411<br>Supplier of tide tables for over 700 locations in the UK and Ireland</strong></td>
						</tr>
					</tbody>
				</table>
